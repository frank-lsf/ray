...
class TaskPoolMapOperator(MapOperator):
    ...
    def incremental_resource_usage(
        ...
        return ExecutionResources(
            ...
            # average_bytes_change_per_task will be updated in runtime. 
            object_store_memory=self._metrics.average_bytes_change_per_task or self._metrics.obj_store_mem_max_pending_output_per_task or 0,
        )
